class Hws::Connectors::VirtualAccountsController < Hws::Connectors::WebhooksController
  ...
  def notify
    ...
    beneficiary = Hws::Connectors::Dto::Beneficiary.new(account_number: params['bene_account_no'], account_ifsc: params['bene_account_ifsc'])
    remitter_details = Hws::Connectors::Dto::Beneficiary.new(account_number: params['rmtr_account_no'], account_ifsc: params['rmtr_account_ifsc'],
                                                             note: params['rmtr_to_bene_note'], name: params['rmtr_full_name'])
    remitter = Hws::Connectors::Dto::Remitter.new(beneficiary: remitter_details)
    ...
    Hws::Connectors.webhooks.to_h['virtual_accounts'].to_h[params['bank']].call(response)
